...
public class ML_C4_5 extends MultiLabelLearnerBase{
	private ML_C4_5[] successors;
	...
	protected void buildInternal(MultiLabelInstances trainingSet) throws Exception{
		...
		if(num_instances == 0) {
			...
			output = new MultiLabelOutput(confidences,0.5);
		}
	...
	protected MultiLabelOutput makePredictionInternal(Instance instance){
		...
		if(m_Attribute == null && output!=null)
			return output;
		
		double value = instance.value(m_Attribute);
		int index = (int)value;
		ML_C4_5 corresponding_successor = successors[index]; 
