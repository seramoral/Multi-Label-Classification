...
public class CalibratedLabelRanking extends BinaryAndPairwise {
    ...
    public static void main(String[] args) throws InvalidDataException, Exception {
    	...
    	String file_results = location + "/CalibratedBasedRanking";
		int num_folds = 5;
		int num_learners = 3;
		...
		MultiLabelLearner learner1 = new CalibratedLabelRanking(base1);
		MultiLabelLearner learner2 = new CalibratedLabelRanking(base2);
		MultiLabelLearner learner3 = new CalibratedLabelRanking(base3);
		learners[0] = learner1;
		learners[1] = learner2;
		learners[2] = learner3;
